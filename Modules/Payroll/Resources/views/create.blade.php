                        ...
                        <form id="payroll-form" action="{{ route('payrolls.store') }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="nama" type="text" class="form-control" name="nama" required readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="pph21" type="text" class="form-control" name="pph21" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="gaji_pokok" type="text" class="form-control" name="gaji_pokok" required>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="tunjangan_jabatan" type="text" class="form-control" name="tunjangan_jabatan" required>
                                            <div class="input-group-append">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="tunjangan_konsumsi" type="text" class="form-control" name="tunjangan_konsumsi" required>
                                            <div class="input-group-append">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="tunjangan_harian" type="text" class="form-control" name="tunjangan_harian" required>
                                            <div class="input-group-append">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="bonus_target" type="text" class="form-control" name="bonus_target" required>
                                            <div class="input-group-append">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="asuransi" type="text" class="form-control" name="asuransi" required>
                                            <div class="input-group-append">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    Create Payroll <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
