...
@section('content')
    <div class="container-fluid">
        <form id="customer-form" action="{{ route('customers.update', $customer) }}" method="POST">
            @csrf
            @method('patch')
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">Update Anggota <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category" id="category" required>
                                            ...
                                            <option value="Customer General" {{ $customer->category == 'Customer General' ? 'selected' : ''}}>Customer General</option>
                                            <option value="Reseller" {{ $customer->category == 'Reseller' ? 'selected' : ''}}>Reseller</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="min_order" type="text" class="form-control" name="min_order" required value="{{ $customer->min_order }}">
                                    </div>
                                </div>
