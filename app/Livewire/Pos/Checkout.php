...
class Checkout extends Component
{
    ...
    public function mount($cartInstance, $customers) {
        ...
        $categoryList = [];
        $categoryList[0]["id"] = "Customer General";
        $categoryList[0]["name"] = "Customer General";
        $categoryList[1]["id"] = "Reseller";
        $categoryList[1]["name"] = "Reseller";
    ...
    {
        if (!is_null($category)) {
            $this->customers = Customer::where('category', $category)->get();
        }
    } 
}
