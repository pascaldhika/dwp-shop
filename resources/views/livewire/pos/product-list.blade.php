        ...
        <div class="card-body">
            ...
            <div class="row position-relative">
                ...
                @forelse($products as $product)
                    <div wire:click.prevent="selectProduct({{ $product }})" class="col-lg-4 col-md-6 col-xl-3" style="cursor: pointer;margin-bottom:29px;">
                        <div class="card border-0 shadow h-100">
                            <div class="position-relative">
                                <img height="100%" src="{{ $product->getFirstMediaUrl('images') }}" class="card-img-top" alt="Product Image">
