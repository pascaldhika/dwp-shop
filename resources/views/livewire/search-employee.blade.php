        ...
        <div class="card-body">
            <div class="form-group mb-0">
                <div class="input-group">
                    ...
                    <input wire:keydown.escape="resetQuery" wire:model.live.debounce.500ms="query" type="text" class="form-control search" placeholder="Type Employee name or nik....">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <ul class="list-group list-group-flush">
                        @foreach($search_results as $result)
                            <li class="list-group-item list-group-item-action">
                                <a wire:click="resetQuery" wire:click.prevent="selectEmployee({{ $result }})" href="#">
                                    {{ $result->nik }} | {{ $result->nama }}
                                </a>
                            </li>
                        @endforeach
