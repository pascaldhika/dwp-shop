...
@can('access_payrolls|access_employees')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('payrolls.*') || request()->routeIs('employees.*') ? 'c-show' : '' }}">
        <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="c-sidebar-nav-icon bi bi-wallet2" style="line-height: 1;"></i> Human Resources
        </a>
        <ul class="c-sidebar-nav-dropdown-items">
            ...
            @can('access_payrolls')
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link {{ request()->routeIs('payrolls.*') ? 'c-active' : '' }}" href="{{ route('payrolls.index') }}">
                        <i class="c-sidebar-nav-icon bi bi-journal-plus" style="line-height: 1;"></i> Payrolls
                    </a>
                </li>
            @endcan
        </ul>
